...
CREATE SYMMETRIC KEY [AccountNumberKey] WITH
    ...
    ENCRYPTION BY PASSWORD = N'A4dTyP@clear'
GO 
GRANT VIEW DEFINITION ON SYMMETRIC KEY:: ssnkey TO preprod_miec_app_user ; 
go
GRANT VIEW DEFINITION ON SYMMETRIC KEY:: birthdatekey TO preprod_miec_app_user; 
Go
GRANT VIEW DEFINITION ON SYMMETRIC KEY:: AccountNumberKey TO preprod_miec_app_user; 
Go
GRANT VIEW DEFINITION ON SYMMETRIC KEY:: ssnkey TO preprod_miec_app_user; 
go
GRANT VIEW DEFINITION ON SYMMETRIC KEY:: birthdatekey TO preprod_miec_app_user;
...
GRANT CONTROL ON CERTIFICATE::OMSPIICert TO	preprod_miec_app_user;
GRANT CONTROL ON SYMMETRIC KEY::AccountNumberKey TO  preprod_miec_app_user;
GRANT CONTROL ON SYMMETRIC KEY::birthDateKey TO  preprod_miec_app_user;
GRANT CONTROL ON SYMMETRIC KEY::ssnKey TO  preprod_miec_app_user;
